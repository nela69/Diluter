...
#         self.sel_cam_width.insert(0, str(hpg.picam_config['resolution'][0]))
...
#         self.sel_cam_exptime = tki.Spinbox(self.panel2, from_= 10, to = 9999999, increment = 1000)
...
#         self.sel_cam_gainR.place(relwidth = 0.25, relx = 0.44, rely = 0.25 + offset_y)
...
#         self.sel_cam_gainB.place(relwidth = 0.25, relx = 0.74, rely = 0.25 + offset_y)
# 
...
#         self.sel_cam_meter.place(relwidth = 0.5, relx = 0.47, rely = 0.37 + offset_y)
# 
...
#         grab_btn.place(relwidth = 0.5, relheight = 0.05, relx = 0.25, rely = 0.93)
        ...
        btn21 = tki.Button(self.panel2, text="Edit Config", pady = 10, justify = "left", height = 1,command = self.editConfig)
        btn21.pack(side = "top", fill = "x")
...
#        HoloPiNotes(self.root, self.panel2, edit_path).open_file()
    ...
    def updatePiSettings(self):
        ...
        hpg.picam_config['shutter_speed'] = float(self.sel_cam_exptime.get())
        ...
        hpg.picam_config['framerate'] = float(self.sel_cam_acqframerate.get())
...
#         hpg.bas_camera.CenterY.SetValue(False)
        ...
        hpg.picam_config['zoom'] = (hpg.cropx_low, hpg.cropy_low, hpg.cropx_high, hpg.cropy_high)
